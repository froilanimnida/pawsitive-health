        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-sm text-red-700">
              Don&apos;t delay! Go to your nearest emergency veterinary clinic immediately.
              Call ahead if possible to let them know you&apos;re coming.
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                <h4 className={`font-medium ${
                  contact.isEmergency ? 'text-red-800' : 'text-gray-900'
                }`}>
                  {contact.name}
                </h4>
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-sm text-blue-700">
              Always have your regular vet&apos;s contact information accessible and consider
              saving emergency clinic contacts in your phone.
            </p>
          </div>
        </div>
      </div>
